...
console.log(big.tan(big.atan(big.float.from('0.1e2',1000), 1000), 1000).toString(10, Infinity));
...
const t = big.float.from('42.1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890');
...
console.log(t.pow(big.float.from('-3')).toString());
